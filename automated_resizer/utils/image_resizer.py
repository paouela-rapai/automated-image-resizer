...
logging.basicConfig(filename='image_resizer.log',
                    level=logging.INFO,
...
class ImageResizer:
    ...
    def traverse_directory(self):
        ...
        for extension in [
            ...
            image_files.extend(glob.glob(os.path.join(self.path, "**", extension),
                                         recursive=True))
        return image_files
    ...
    def resize_image(self, image):
        with Image.open(image) as img:
            try:
                ...
                output_image = os.path.join(self.output_dir,
                                            os.path.basename(image))
                img.save(output_image)
                self.logger.info(f"{image} resized")
    ...
    def resize_images(self):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            futures = [executor.submit(self.resize_image, image)
